...
Pod::Spec.new do |s|
  s.name             = 'RHImgPicker'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RHImgPicker.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/RHImgPicker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Rizan Hamza' => 'rizan.hamza@outlook.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/RHImgPicker.git', :tag => s.version.to_s }
